...
def read_dataset(dataset_info: Union[DatasetMeta, Text, int],
    ...
    from external system and generates the :class:`~ai_flow.meta.ai_graph.ai_node.ReadDatasetNode` with
    :class:`~ai_flow.meta.dataset_meta.DatasetMeta`.

    :param dataset_info: Information about the dataset read. The type of dataset information could be
                                      :class:`~ai_flow.meta.dataset_meta.DatasetMeta` or Text or int. The `dataset_info`
                                      means the name of dataset when the type is Text and it means the id of dataset
                                      when the type is int, which gets the metadata of dataset by the id.or name of
                                      dataset at default.
    ...
    :param name: Name of the reading dataset operator represent for the
                            :class:`~ai_flow.meta.ai_graph.ai_node.ReadDatasetNode`.
...
def write_dataset(input: Channel,
    ...
    to external system and generates the :class:`~ai_flow.meta.ai_graph.ai_node.WriteDatasetNode` with
    :class:`~ai_flow.meta.dataset_meta.DatasetMeta`.

    :param input: The input :class:`~ai_flow.graph.channel.Channel` from the operator that generates the data used to
                            write dataset.
    :param dataset_info: Information about the dataset writen. The type of dataset information could be
                                      :class:`~ai_flow.meta.dataset_meta.DatasetMeta` or Text or int. The `dataset_info`
                                      means the name of dataset when the type is Text and it means the id of dataset
                                      when the type is int, which gets the metadata of dataset by the id.or name of
                                      dataset at default.
    ...
    :param name: Name of the writing dataset operator represent for the
                            :class:`~ai_flow.meta.ai_graph.ai_node.WriteDatasetNode`.
    :return: None.
    """
    if isinstance(dataset_info, DatasetMeta):
        dataset_meta = dataset_info
...
def transform(input: Union[Channel, List[Channel]],
    ...
    The processor generates the transforming :class:`~ai_flow.meta.ai_graph.ai_node.AINode`.
    ...
    :param transform_processor: The user-defined processor composed of the logic that transforms.
    :param output_num: The output :class:`~ai_flow.graph.channel.Channel` number of the transforming operator.
                                      The default value is 1.
    :param name: Name of the transforming operator represent for the :class:`~ai_flow.meta.ai_graph.ai_node.AINode`.
...
def train(input: Union[Channel, List[Channel]],
    ...
    :class:`~ai_flow.meta.ai_graph.ai_node.AINode`.

    :param input: List of the input :class:`~ai_flow.graph.channel.Channel` that contains the multiple channels from the
                           operators which generate the data used to train model.
    :param model_info: Information about the model trained. The type of model could be
                                     :class:`~ai_flow.meta.model_meta.ModelMeta` or Text or int. The `model_info`
                                     means the name of model when the type is Text and it means the id of model when the
                                     type is int, which gets the metadata of model by the id or name of model.
    :param training_processor: The user-defined processor composed of the logic that trains model.
    :param base_model_info: Information about the base model for training. The type of model could be
    ...
    :param name: Name of the model training operator represent for the :class:`~ai_flow.meta.ai_graph.ai_node.AINode`.
    :return: Returns the :class:`~ai_flow.graph.channel.Channel` when the `output_num` is 1 and returns
                 Tuple[:class:`~ai_flow.graph.channel.Channel`] when the `output_num` is bigger than 1.
    """
...
def predict(input: Union[Channel, List[Channel]],
            ...
            name: Text = None) -> Union[Channel, Tuple[Channel]]:
    """
    Predicts model through the user-defined processor with the information of model and model version based on the input
    ...
    :param model_info: Information about the model predicted. The type of model could be
                                     :class:`~ai_flow.meta.model_meta.ModelMeta` or Text or int. The `model_info`
                                     means the name of model when the type is Text and it means the id of model when the
                                     type is int, which gets the metadata of model by the id or name of model.
    :param prediction_processor: The user-defined processor composed of the logic that predicts model.
    :param model_version_info: Information about the model version predicted. The type of model version could be
                                                  :class:`~ai_flow.meta.model_meta.ModelVersionMeta` or Text. The
                                                  `model_version_info` means the version of model version when the type
                                                  is Text, which gets the metadata of model version by the version of
                                                  model version.
    :param output_num: The output :class:`~ai_flow.graph.channel.Channel` number of the model prediction operator.
                                      The default value is 1.
    :param name: Name of the model prediction operator represent for the :class:`~ai_flow.meta.ai_graph.ai_node.AINode`.
    :return: Returns the :class:`~ai_flow.graph.channel.Channel` when the `output_num` is 1 and returns
                 Tuple[:class:`~ai_flow.graph.channel.Channel`] when the `output_num` is bigger than 1.
    """
    if isinstance(model_info, ModelMeta):
...
def evaluate(input: Union[Channel, List[Channel]],
    ...
    :param model_info: Information about the model evaluated. The type of model could be
                                     :class:`~ai_flow.meta.model_meta.ModelMeta` or Text or int. The `model_info`
                                     means the name of model when the type is Text and it means the id of model when the
                                     type is int, which gets the metadata of model by the id or name of model.
    ...
    :param output_num: The output :class:`~ai_flow.graph.channel.Channel` number of the model evaluating operator.
                                      The default value is 0.
    :param name: Name of the model evaluating operator represent for the :class:`~ai_flow.meta.ai_graph.ai_node.AINode`.
    :return: Returns the :class:`~ai_flow.graph.channel.Channel` when the `output_num` is 1 and returns
                 Tuple[:class:`~ai_flow.graph.channel.Channel`] when the `output_num` is bigger than 1.
    """
    if isinstance(model_info, ModelMeta):
...
def dataset_validate(input: Channel,
    ...
    The processor generates the dataset validating :class:`~ai_flow.meta.ai_graph.ai_node.AINode`.
    ...
    :param name: Name of the dataset validating operator represent for the :class:`~ai_flow.meta.ai_graph.ai_node.AINode`.
    :return: Returns the :class:`~ai_flow.graph.channel.Channel` when the `output_num` is 1 and returns
                 Tuple[:class:`~ai_flow.graph.channel.Channel`] when the `output_num` is bigger than 1.
        """
    return user_define_operation(input=input,
...
def model_validate(input: Union[Channel, List[Channel]],
    ...
    :param model_info: Information about the model validated. The type of model could be
                                     :class:`~ai_flow.meta.model_meta.ModelMeta` or Text or int. The `model_info`
                                     means the name of model when the type is Text and it means the id of model when the
                                     type is int, which gets the metadata of model by the id or name of model.
    :param model_validation_processor: The user-defined processor composed of the logic that validates model.
    :param model_version_info: Information about the model version validated. The type of model version could be
                                                  :class:`~ai_flow.meta.model_meta.ModelVersionMeta` or Text. The
                                                  `model_version_info` means the version of model version when the type
                                                  is Text, which gets the metadata of model version by the version of
                                                  model version.
    :param base_model_version_info: Information about the base model version for validating. The type of model version
                                                            could be :class:`~ai_flow.meta.model_meta.ModelVersionMeta`
                                                            or Text. The `base_model_version_info` means the version of
                                                            model version when the type is Text, which gets the metadata
                                                            of model version by the version of model version.
    :param output_num: The output :class:`~ai_flow.graph.channel.Channel` number of the model validating operator.
                                      The default value is 0.
    :param name: Name of the model validating operator represent for the :class:`~ai_flow.meta.ai_graph.ai_node.AINode`.
    :return: Returns the :class:`~ai_flow.graph.channel.Channel` when the `output_num` is 1 and returns
                 Tuple[:class:`~ai_flow.graph.channel.Channel`] when the `output_num` is bigger than 1.
    """
    if isinstance(model_info, ModelMeta):
...
def push_model(model_info: Union[ModelMeta, Text, int],
    ...
    :param model_info: Information about the model pushed. The type of model could be
                                     :class:`~ai_flow.meta.model_meta.ModelMeta` or Text or int. The `model_info`
                                     means the name of model when the type is Text and it means the id of model when the
                                     type is int, which gets the metadata of model by the id or name of model.
    :param pushing_model_processor: The user-defined processor composed of the logic that pushes model.
    :param model_version_info: Information about the model version pushed. The type of model version could be
                                                  :class:`~ai_flow.meta.model_meta.ModelVersionMeta` or Text. The
                                                  `model_version_info` means the version of model version when the type
                                                  is Text, which gets the metadata of model version by the version of
                                                  model version.
    :param name: Name of the model pushing operator represent for the :class:`~ai_flow.meta.ai_graph.ai_node.AINode`.
    :return: None.
    """
...
def user_define_operation(input: Union[None, Channel, List[Channel]] = None,
    ...
    """
    Operation through the user-defined processor based on the input :class:`~ai_flow.graph.channel.Channel`. The processor
    generates the :class:`~ai_flow.meta.ai_graph.ai_node.AINode`.
    ...
    :param name: Name of the operator represent for the :class:`~ai_flow.meta.ai_graph.ai_node.AINode`.
...
def action_on_event(job_name: Text,
    ...
    :param value_condition: The event :class:`~ai_flow.workflow.control_edge.ValueCondition`, which value is EQUALS or UPDATE.
                                            ...
                                            will start or restart when in the the condition that the notification service
                                            has a update operation on the event key which event value belongs.
    :param action: The :class:`~ai_flow.workflow.control_edge.JobAction` acts on the source channel which value includes
...
def action_on_events(job_name: Text, event_condition: EventCondition, action: JobAction):
    """
    Define a rule which is the combination of a :class:`~ai_flow.workflow.control_edge.EventCondition` and
...
def action_on_model_version_event(job_name: Text,
    ...
    """
    Add model version control dependency. It means the source channel will start when and only a new model version of
    the specified model is updated in notification service.

    :param job_name: The name of the job triggered.
    :param model_name: The name of the model refer to a specified model.
    :param model_version_event_type: The type of the model version, which value is of the
...
def action_on_dataset_event(job_name: Text,
                            ...
                            action: JobAction = JobAction.START):
    """
    Add dataset control dependency. It means the source channel will start when and only the a new dataset of the
...
def action_on_job_status(job_name: Text,
                         ...
                         action: JobAction = JobAction.START):
    """
    Trigger the job with the given name when the status of the upstream job changes.
